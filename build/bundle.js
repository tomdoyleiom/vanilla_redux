...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _satelliteActions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./satelliteActions */ \"./src/actions/satelliteActions.js\");\n\n\n/**\n * populates the application with all data it needs for initial load.\n */\nfunction populateApplication() {\n  return async (dispatch) => {\n    dispatch(_satelliteActions__WEBPACK_IMPORTED_MODULE_0__[\"default\"].getSatelliteCategoriesAsync());\n  };\n}\n\nconst ApplicationActions = {\n  populateApplication,\n};\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (ApplicationActions);\n\n\n//# sourceURL=webpack:///./src/actions/applicationActions.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var redux_actions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux-actions */ \"./node_modules/redux-actions/es/index.js\");\n\n\nconst selectMenuItem = Object(redux_actions__WEBPACK_IMPORTED_MODULE_0__[\"createAction\"])('SELECT_MENUITEM');\nconst addFeedback = Object(redux_actions__WEBPACK_IMPORTED_MODULE_0__[\"createAction\"])('ADD_FEEDBACK');\n\nconst menuActions = {\n  addFeedback,\n  selectMenuItem,\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (menuActions);\n\n\n//# sourceURL=webpack:///./src/actions/menuActions.js?");

/***/ }),

/***/ "./src/actions/satelliteActions.js":
/*!*****************************************!*\
  !*** ./src/actions/satelliteActions.js ***!
  \*****************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _actions_menuActions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../actions/menuActions */ \"./src/actions/menuActions.js\");\n/* harmony import */ var _menuPanels_bikePanel__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./menuPanels/bikePanel */ \"./src/components/menu/menuPanels/bikePanel.js\");\n/* harmony import */ var _menuPanels_cardiffPark__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menuPanels/cardiffPark */ \"./src/components/menu/menuPanels/cardiffPark.js\");\n/* harmony import */ var _utilities_clear__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../utilities/clear */ \"./src/utilities/clear.js\");\n/* harmony import */ var _utilities_html__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../utilities/html */ \"./src/utilities/html.js\");\n/* harmony import */ var _menuPanels_issPanel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./menuPanels/issPanel */ \"./src/components/menu/menuPanels/issPanel.js\");\n/* harmony import */ var _menuPanels_satellitePanel__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./menuPanels/satellitePanel */ \"./src/components/menu/menuPanels/satellitePanel.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../store */ \"./src/store.js\");\n/* harmony import */ var _menuTemplate__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./menuTemplate */ \"./src/components/menu/menuTemplate.js\");\n\n\n\n\n\n\n\n\n\n\nfunction renderPanel(panel) {\n  return Object(_utilities_html__WEBPACK_IMPORTED_MODULE_4__[\"default\"])(panel);\n}\n\nfunction renderMenu() {\n  // clear rendered html first\n  const { selectMenuItem } = _actions_menuActions__WEBPACK_IMPORTED_MODULE_0__[\"default\"];\n  const { menu } = _store__WEBPACK_IMPORTED_MODULE_7__[\"default\"].getState();\n  const locTemplate = _menuTemplate__WEBPACK_IMPORTED_MODULE_8__[\"default\"];\n  const tabs = locTemplate.querySelectorAll('.tablinks');\n  tabs[0].addEventListener('click', (e) => {\n    e.preventDefault();\n    e.stopImmediatePropagation();\n    _store__WEBPACK_IMPORTED_MODULE_7__[\"default\"].dispatch(selectMenuItem('Satellite'));\n  });\n  tabs[1].addEventListener('click', (e) => {\n    e.preventDefault();\n    e.stopImmediatePropagation();\n    _store__WEBPACK_IMPORTED_MODULE_7__[\"default\"].dispatch(selectMenuItem('ISS-Tracker'));\n  });\n  tabs[2].addEventListener('click', (e) => {\n    e.preventDefault();\n    e.stopImmediatePropagation();\n    _store__WEBPACK_IMPORTED_MODULE_7__[\"default\"].dispatch(selectMenuItem('NextBike-Loc'));\n  });\n  tabs[3].addEventListener('click', (e) => {\n    e.preventDefault();\n    e.stopImmediatePropagation();\n    _store__WEBPACK_IMPORTED_MODULE_7__[\"default\"].dispatch(selectMenuItem('CardiffPark-Poly'));\n  });\n  let panel = null;\n  switch (menu.selectedTab) {\n    case ('SAT_TRACK'):\n      panel = Object(_menuPanels_satellitePanel__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\n      break;\n    case ('ISS-Tracker'):\n      panel = renderPanel(_menuPanels_issPanel__WEBPACK_IMPORTED_MODULE_5__[\"default\"]);\n      break;\n    case ('NextBike-Loc'):\n      panel = renderPanel(_menuPanels_bikePanel__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\n      break;\n    case ('CardiffPark-Poly'):\n      panel = renderPanel(_menuPanels_cardiffPark__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n      break;\n    default:\n      panel = Object(_menuPanels_satellitePanel__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\n  }\n  const panelContainer = locTemplate.querySelector('.panelContainer');\n  Object(_utilities_clear__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(panelContainer);\n  panelContainer.appendChild(panel);\n  return locTemplate;\n}\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (renderMenu);\n\n\n//# sourceURL=webpack:///./src/components/menu/index.js?");

/***/ }),

/***/ "./src/components/menu/menuPanels/bikePanel.js":
/*!*****************************************************!*\
  !*** ./src/components/menu/menuPanels/bikePanel.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _actions_applicationActions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./actions/applicationActions */ \"./src/actions/applicationActions.js\");\n/* harmony import */ var _pages_details__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pages/details */ \"./src/pages/details/index.js\");\n/* harmony import */ var _pages_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/map */ \"./src/pages/map/index.js\");\n/* harmony import */ var _components_tabs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/tabs */ \"./src/components/tabs/index.js\");\n/* harmony import */ var _pages_themes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./pages/themes */ \"./src/pages/themes/index.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./store */ \"./src/store.js\");\n\n\n\n\n\n\n\nwindow.render = () => {\n  const { tab } = _store__WEBPACK_IMPORTED_MODULE_5__[\"default\"].getState();\n  document.getElementById('pageContainer').innerHTML = '';\n  Object(_components_tabs__WEBPACK_IMPORTED_MODULE_3__[\"default\"])('tabContainer');\n  switch (tab) {\n    case 'themes':\n      Object(_pages_themes__WEBPACK_IMPORTED_MODULE_4__[\"default\"])('pageContainer');\n      break;\n    case 'map':\n      Object(_pages_map__WEBPACK_IMPORTED_MODULE_2__[\"default\"])('pageContainer');\n      break;\n    case 'details':\n      Object(_pages_details__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('pageContainer');\n      break;\n    default:\n  }\n};\n\nwindow.onload = () => {\n  _store__WEBPACK_IMPORTED_MODULE_5__[\"default\"].subscribe(window.render);\n  _store__WEBPACK_IMPORTED_MODULE_5__[\"default\"].dispatch(_actions_applicationActions__WEBPACK_IMPORTED_MODULE_0__[\"default\"].populateApplication());\n};\n\n\n//# sourceURL=webpack:///./src/main.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utilities_html__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../utilities/html */ \"./src/utilities/html.js\");\n/* harmony import */ var _utilities_map__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../utilities/map */ \"./src/utilities/map.js\");\n/* harmony import */ var _components_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../components/menu */ \"./src/components/menu/index.js\");\n/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../store */ \"./src/store.js\");\n\n\n\n\n\n/* eslint-disable operator-linebreak */\nfunction renderMapPage(target = 'pageContainer') {\n  const { map } = _store__WEBPACK_IMPORTED_MODULE_3__[\"default\"].getState();\n  Object(_utilities_map__WEBPACK_IMPORTED_MODULE_1__[\"default\"])('mapouter', map);\n\n  // houses arcgis map\n  // get the basic template HTML\n  const pageTemplate = _utilities_html__WEBPACK_IMPORTED_MODULE_0__[\"default\"]`\n  <div id=\"mapouter\"></div>\n  `;\n\n  const targetElement = document.getElementById(target);\n\n  targetElement.innerHTML = '';\n  targetElement.appendChild(pageTemplate);\n  targetElement.appendChild(Object(_components_menu__WEBPACK_IMPORTED_MODULE_2__[\"default\"])());\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (renderMapPage);\n\n\n//# sourceURL=webpack:///./src/pages/map/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var redux__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! redux */ \"./node_modules/redux/es/redux.js\");\n/* harmony import */ var _mapReducer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mapReducer */ \"./src/reducers/mapReducer.js\");\n/* harmony import */ var _menuReducer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./menuReducer */ \"./src/reducers/menuReducer.js\");\n/* harmony import */ var _satelliteReducer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./satelliteReducer */ \"./src/reducers/satelliteReducer.js\");\n/* harmony import */ var _tabReducer__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tabReducer */ \"./src/reducers/tabReducer.js\");\n/* harmony import */ var _themeReducer__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./themeReducer */ \"./src/reducers/themeReducer.js\");\n\n\n\n\n\n\n\nconst rootReducer = Object(redux__WEBPACK_IMPORTED_MODULE_0__[\"combineReducers\"])({\n  themes: _themeReducer__WEBPACK_IMPORTED_MODULE_5__[\"default\"],\n  tab: _tabReducer__WEBPACK_IMPORTED_MODULE_4__[\"default\"],\n  menu: _menuReducer__WEBPACK_IMPORTED_MODULE_2__[\"default\"],\n  satellites: _satelliteReducer__WEBPACK_IMPORTED_MODULE_3__[\"default\"],\n  map: _mapReducer__WEBPACK_IMPORTED_MODULE_1__[\"default\"],\n});\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (rootReducer);\n\n\n//# sourceURL=webpack:///./src/reducers/index.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return menuReducer; });\nconst defaultState = {\n  selectedTab: 'SAT_TRACK',\n  feedback: '',\n};\n\nfunction menuReducer(state = defaultState, action = {}) {\n  switch (action.type) {\n    case 'SELECT_MENUITEM':\n      return { ...state, selectedTab: action.payload };\n    case 'ADD_FEEDBACK':\n      return state;\n    default:\n      return state;\n  }\n}\n\n\n//# sourceURL=webpack:///./src/reducers/menuReducer.js?");

/***/ }),

/***/ "./src/reducers/satelliteReducer.js":
/*!******************************************!*\
  !*** ./src/reducers/satelliteReducer.js ***!
  \******************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return satelliteReducer; });\n/* harmony import */ var _actions_ActionTypes__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../actions/ActionTypes */ \"./src/actions/ActionTypes.js\");\n\r\n\r\nconst defaultState = {\r\n  categories: [],\r\n  satelliteData: {}\r\n};\r\n\r\nfunction satelliteReducer(state = defaultState, action = {}) {\r\n  switch (action.type) {\r\n    case _actions_ActionTypes__WEBPACK_IMPORTED_MODULE_0__[\"SatelliteActionTypes\"].ADD_CATEGORIES:\r\n      return { ...state, categories: [...action.payload] };\r\n    case _actions_ActionTypes__WEBPACK_IMPORTED_MODULE_0__[\"SatelliteActionTypes\"].CLEAR_CATEGORIES:\r\n      return { ...state, categories: [] };\r\n    case _actions_ActionTypes__WEBPACK_IMPORTED_MODULE_0__[\"SatelliteActionTypes\"].GET_SATELLITES_DATA:\r\n      return { ...state, satelliteData: action.payload };\r\n    case _actions_ActionTypes__WEBPACK_IMPORTED_MODULE_0__[\"SatelliteActionTypes\"].CLEAR_SATELLITES_DATA:\r\n      return { ...state, satelliteData: {} };\r\n    default:\r\n      return state;\r\n  }\r\n}\r\n\n\n//# sourceURL=webpack:///./src/reducers/satelliteReducer.js?");
